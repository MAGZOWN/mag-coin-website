      ...
      <main style={styles.main}>
        <section style={styles.container}>
          ...
          <p style={styles.lead}>
            ...
            guided by integrity, transparency, responsible stewardship, and
          ...
          <div style={styles.card}>
            ...
            <p>
              MAG COIN began with a simple intention: to build a project
              honestly, carefully, and transparently. Rather than depending on
              hype, the project is being developed step by step with public
              documentation, verifiable blockchain records, and long-term
              responsibility.
            </p>
          </div>
          ...
          <p style={styles.footerNote}>
            MAG COIN does not promise guaranteed returns or future prices. The
            project focuses on responsible development, clear communication, and
            verifiable progress.
          </p>
        </section>
      </main>

        ...
        <section style={styles.container}>
          ...
          <div style={styles.card}>
            ...
            <ul style={styles.list}>
              ...
              <li>Official transparency reports as the project develops</li>
            </ul>
          </div>
          ...
          <div style={styles.card}>
            ...
            <p>
              ...
              investment outcomes. Blockchain projects carry risk, and all users
              should conduct independent research before taking any action.
            </p>
          </div>
        </section>
      </main>
